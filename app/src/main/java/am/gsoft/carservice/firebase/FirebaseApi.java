package am.gsoft.carservice.firebase;
...
//    mFirebaseDb.setPersistenceEnabled(true);
    ...
    serviceDatabaseReference = getChildDbReferance(Path.SERVICES);
...
//  }
  ...
  public DatabaseReference getServiceDatabaseReference() {
    return serviceDatabaseReference;
  }
