package am.gsoft.carservice.util.helpers;

import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.AUTH_TOKEN;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.CAR_OIL_LIST;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.DRIVEN_KM;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.FIREBASE_TOKEN;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.FIRST_AUTH;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.IMPORT_INITIALIZED;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.LAST_OPEN_ACTIVITY;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.OIL_NOTES;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.PERMISSIONS_SAVE_FILE_WAS_REQUESTED;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.SERVICE_PHONE_NUMBER;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_CAR_LIST;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_EMAIL;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_FNAME;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_ID;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_KEY;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_LNAME;
import static am.gsoft.carservice.util.helpers.SharedHelper.Constants.USER_PHONE_NUMBER;
...
//  }
  ...
  public void saveServicePhoneNumber(String phoneNumber) {
    savePref(SERVICE_PHONE_NUMBER, phoneNumber);
  }

  public String getServicePhoneNumber() {
    return getPref(SERVICE_PHONE_NUMBER, null);
  }
