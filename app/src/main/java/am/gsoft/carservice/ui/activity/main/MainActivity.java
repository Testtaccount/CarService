package am.gsoft.carservice.ui.activity.main;
...
import am.gsoft.carservice.ui.activity.BaseActivity;
import am.gsoft.carservice.ui.activity.SplashActivity;
import am.gsoft.carservice.ui.activity.setting.SettingsActivity;
import am.gsoft.carservice.ui.adapter.MyCarSpinnerAdapter;
import am.gsoft.carservice.ui.fragment.UsersListFragment;
import am.gsoft.carservice.util.VersionUtils;
import am.gsoft.carservice.util.manager.DialogManager;
import am.gsoft.carservice.util.manager.FragmentTransactionManager;
import am.gsoft.carservice.util.manager.SnackBarManager;
...
public class MainActivity extends BaseActivity implements OnClickListener, OnItemSelectedListener,UsersListFragment.OnUsersListFragmentInteractionListener {
...
//  private boolean showProgress;
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    customizeActionBar();
    initFields();
    openScreen(UsersListFragment.newInstance(), false);

//    mViewModel.getUsers();
//    .observeForever(new Observer<Resource<List<User>>>() {
//      @Override
...
//    AppDatabase.getInstance(getApplicationContext()).mUserDao().getAll().observeForever(new Observer<List<User>>() {
//      @Override
...
//    findViewById(R.id.ll_main_content).setVisibility(View.GONE);
  ...
  @Override
  public void onUsersListItemClickListener(User user) {
    Log.d(TAG, ""+user);
  }
}