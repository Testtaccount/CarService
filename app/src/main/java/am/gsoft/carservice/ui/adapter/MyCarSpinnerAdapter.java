...
public class MyCarSpinnerAdapter extends ArrayAdapter<Car> {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    ((ImageView) convertView.findViewById(R.id.icon)).setImageDrawable(mResources.getDrawable(mResources.getIdentifier(carForPosition.getIcon(), "drawable", "am.gsoft.carservice")));//setBackgroundResource(carBrandsList.getAppNotification(position).getIcon());
...
//      carViewHolder.setYear((TextView) row.findViewById(R.id.tv_year));
    ...
    Resources mResources = context.getResources();
    ((MyCarViewHolder) row.getTag()).getIcon().setImageDrawable(mResources.getDrawable(mResources.getIdentifier(car.getIcon(), "drawable", "am.gsoft.carservice")));
